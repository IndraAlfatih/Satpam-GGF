...
public class FormPengamatanSingkongStekPanjangPresenter {

    final IFormPengamatanSingkongStekPanjangView view;
    private final Retrofit restService;
    private final String TAG = "Auth Presenter";

    FormPengamatanSingkongStekPanjangPresenter(IFormPengamatanSingkongStekPanjangView view) {
        this.view = view;
    ...
    void createPengamatan(SingkongStekPanjangModel model) {
