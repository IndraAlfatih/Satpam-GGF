...
public class FormPengamatanTanamPresenter {

    final IFormPengamatanTanamView view;
    private final Retrofit restService;
    private final String TAG = "Auth Presenter";

    FormPengamatanTanamPresenter(IFormPengamatanTanamView view) {
        this.view = view;
    ...
    void createPengamatan(TanamModel model) {
