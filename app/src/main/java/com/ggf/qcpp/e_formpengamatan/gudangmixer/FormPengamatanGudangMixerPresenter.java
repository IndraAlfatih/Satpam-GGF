...
public class FormPengamatanGudangMixerPresenter {

    final IFormPengamatanGudangMixerView view;
    private final Retrofit restService;
    private final String TAG = "Auth Presenter";

    FormPengamatanGudangMixerPresenter(IFormPengamatanGudangMixerView view) {
        this.view = view;
    ...
    void createPengamatan(GudangMixerModel model) {
