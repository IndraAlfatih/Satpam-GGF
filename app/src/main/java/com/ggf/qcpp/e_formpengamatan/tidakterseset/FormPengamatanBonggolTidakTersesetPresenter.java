...
public class FormPengamatanBonggolTidakTersesetPresenter {

    final IFormPengamatanBonggolTidakTersesetView view;
    private final Retrofit restService;
    private final String TAG = "Auth Presenter";

    FormPengamatanBonggolTidakTersesetPresenter(IFormPengamatanBonggolTidakTersesetView view) {
        this.view = view;
    ...
    void createPengamatan(BonggolTidakTersesetModel model) {
