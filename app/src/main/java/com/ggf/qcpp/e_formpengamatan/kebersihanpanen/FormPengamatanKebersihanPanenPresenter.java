...
public class FormPengamatanKebersihanPanenPresenter {

    final IFormPengamatanKebersihanPanenView view;
    private final Retrofit restService;
    private final String TAG = "Auth Presenter";

    FormPengamatanKebersihanPanenPresenter(IFormPengamatanKebersihanPanenView view) {
        this.view = view;
    ...
    void createPengamatan(PanenModel model) {
