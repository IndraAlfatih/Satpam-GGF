...
import com.ggf.qcpp.e_formpengamatan.subsoiler.model.PlotModel;
import com.ggf.qcpp.e_formpengamatan.subsoiler.model.SampleModel;
...
public class FormPengamatanSubsoil extends AppCompatActivity implements View.OnClickListener, IFormPengamatanSubsoilerView {
...
//    EditText mNoUnit;
    ...
    View viewnya = null;
    String plot = "0";
    SubsoilerModel model;

    int index = 1;

    List<com.ggf.qcpp.e_formpengamatan.subsoiler.model.PlotModel> dataPlot = new ArrayList<>();
    List<SampleModel> dataSample = new ArrayList<>();

    SweetAlertDialog sweetAlertDialog;
    SampleModel sampleModel = null;
    PlotModel plotModel = null;
    FormPengamatanSubsoilerPresenter presenter;

    private ScrollView scrollView;
    private View contentView;
    private View focusedView;

    private static final String DRAFT_KEY = "draft_subsoil";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_form_pengamatan_subsoil);
        ...
        model = (SubsoilerModel) getIntent().getSerializableExtra("model");
        Log.d("bajakmodel", new Gson().toJson(model));

        presenter = new FormPengamatanSubsoilerPresenter(this);
...
//
//        model.setStd_musim(automusim.getText().toString());
//        model.setSTATUS_PENGAMATAN(statuspengamatan.getText().toString());
//        model.setCOMODITY_BAJAK(autoComodityBajak.getText().toString());
//        model.setStd_jenisbajak(autoJenisBajak.getText().toString());
//        model.setReworking(mReworking.getText().toString());
//
//        TemporaryFormStorage.saveDraft(this, DRAFT_KEY, model);
//        Log.d("Draft", "Draft Subsoil tersimpan");
//    }

    private void saveTemporaryData() {
        // Simpan sementara
        SubsoilerModel draft = new SubsoilerModel();
        ...
        Log.d("Draft Subsoil tersimpan", new Gson().toJson(draft));
    }
...
//        SubsoilerModel draft = TemporaryFormStorage.loadDraft(this, DRAFT_KEY, SubsoilerModel.class);
//        if (draft != null) {
//            Log.d("Draft", "Draft Subsoil ditemukan: " + new Gson().toJson(draft));
//
...
//        // Buat ulang UI sample dari data
//        LayoutInflater inflater = (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);
//        View rowView = inflater.inflate(R.layout.data_subsoil_sample_field, null);
//
//        TextView no_sample = rowView.findViewById(R.id.no_sample);
//        TextView kedalaman = rowView.findViewById(R.id.mKedalaman);
//        TextView aplikasiKerataan = rowView.findViewById(R.id.mAplikasiKerataan);
//        TextView aplikasiKerataan = rowView.findViewById(R.id.mPlot);
//
//        no_sample.setText(String.valueOf(s.getNo_sample()));
//        kedalaman.setText(String.valueOf(s.getKEDALAMAN()));
//        aplikasiKerataan.setText(s.getKerataan_aplikasi());
...
//    }
    ...
    void addPlotForm() {
        ...
        if (mSPK.getText().toString().equals("")) {
            ...
            Toast.makeText(this, "Jenis Subsoil tidak boleh kosong", Toast.LENGTH_SHORT).show();
    ...
    void addSampleForm() {
        LayoutInflater inflater = (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        rowView = inflater.inflate(R.layout.data_subsoil_sample_field, null);
...
//        index +=1 ;
        ...
        autoKerataanAplikasi.getText().clear();
...
//        SweetDialogs.commonError(this, App.getApplication().getString(R.string.notif_offline_mode), false);
    ...
    private static final String[] statuspengamatan2 = new String[]{
            "Inprocess", "Crhosscheck"
    };

    private static final String[] autoJenisBajak2 = new String[]{
            "Bajak Dangkal", "Bajak Sedang", "Bajak Dalam"
    };
    ...
    private static final String[] autoAplikasiPinggiran2 = new String[]{
            "0", "1"
    };
