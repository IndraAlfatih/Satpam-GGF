...
public class FormPengamatanPotensiCrownPresenter {

    final IFormPengamatanPotensiCrownView view;
    private final Retrofit restService;
    private final String TAG = "Auth Presenter";

    FormPengamatanPotensiCrownPresenter(IFormPengamatanPotensiCrownView view) {
        this.view = view;
    ...
    void createPengamatan(PotensiCrownModel model) {
        ...
        restService.create(NetworkService.class).pengamatanPotensiCrown(model)
                .enqueue(new Callback<CommonResponse>() {
                    ...
                    public void onResponse(retrofit2.Call<CommonResponse> call, Response<CommonResponse> CommonRespon) {
                        ...
                        Log.d("responeerror" , new Gson().toJson(CommonRespon.body()));
