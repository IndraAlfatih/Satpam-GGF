...
public class FormPengamatanKebersihanBonggolPresenter {

    final IFormPengamatanKebersihanBonggolView view;
    private final Retrofit restService;
    private final String TAG = "Auth Presenter";

    FormPengamatanKebersihanBonggolPresenter(IFormPengamatanKebersihanBonggolView view) {
        this.view = view;
    ...
    void createPengamatan(KebersihanBonggolModel model) {
        ...
        restService.create(NetworkService.class).pengamatanKebersihanBonggol(model)
                .enqueue(new Callback<CommonResponse>() {
                    ...
                    public void onResponse(retrofit2.Call<CommonResponse> call, Response<CommonResponse> CommonRespon) {
                        ...
                        Log.d("responeerror" , CommonRespon.toString());
