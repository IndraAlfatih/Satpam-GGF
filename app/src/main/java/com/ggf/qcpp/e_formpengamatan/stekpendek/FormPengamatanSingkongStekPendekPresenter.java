...
public class FormPengamatanSingkongStekPendekPresenter {

    final IFormPengamatanSingkongStekPendekView view;
    private final Retrofit restService;
    private final String TAG = "Auth Presenter";

    FormPengamatanSingkongStekPendekPresenter(IFormPengamatanSingkongStekPendekView view) {
        this.view = view;
    ...
    void createPengamatan(SingkongStekPendekModel model) {
...
//                    .header("username", nik)
        ...
        restService.create(NetworkService.class).pengamatanSingkongStekPendek(model)
