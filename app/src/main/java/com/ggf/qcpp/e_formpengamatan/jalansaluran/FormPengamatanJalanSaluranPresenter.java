...
public class FormPengamatanJalanSaluranPresenter {

    final IFormPengamatanJalanSaluranView view;
    private final Retrofit restService;
    private final String TAG = "Auth Presenter";

    FormPengamatanJalanSaluranPresenter(IFormPengamatanJalanSaluranView view) {
        this.view = view;
    ...
    void createPengamatan(JalanSaluranModel model) {
...
//                    .header("username", nik)
        ...
        restService.create(NetworkService.class).pengamatanJalanSaluran(model)
