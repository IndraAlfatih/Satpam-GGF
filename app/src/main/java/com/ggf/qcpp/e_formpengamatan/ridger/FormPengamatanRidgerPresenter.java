...
public class FormPengamatanRidgerPresenter {

    final IFormPengamatanRidgerView view;
    private final Retrofit restService;
    private final String TAG = "Auth Presenter";

    FormPengamatanRidgerPresenter(IFormPengamatanRidgerView view) {
        this.view = view;
    ...
    void createPengamatan(RidgerModel model) {
...
//                        if (CommonRespon.body().getSuccess())
                        ...
                        Log.d("dataRespon ", new Gson().toJson(CommonRespon.body()));
//                        else
...
//                        Log.d("dataError ", new Gson().toJson(call));
                        view.hideLoadingIndicator();
