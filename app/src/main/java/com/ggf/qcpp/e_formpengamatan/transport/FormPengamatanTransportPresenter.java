...
import com.ggf.qcpp.e_formpengamatan.ridger.IFormPengamatanRidgerView;
...
public class FormPengamatanTransportPresenter {

    final IFormPengamatanTransportView view;
    private final Retrofit restService;
    private final String TAG = "Auth Presenter";

    FormPengamatanTransportPresenter(IFormPengamatanTransportView view) {
        this.view = view;
    ...
    void createPengamatan(TransportModel model) {
