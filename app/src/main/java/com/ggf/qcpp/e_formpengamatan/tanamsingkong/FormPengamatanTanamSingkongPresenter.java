...
public class FormPengamatanTanamSingkongPresenter {

    final IFormPengamatanTanamSingkongView view;
    private final Retrofit restService;
    private final String TAG = "Auth Presenter";

    FormPengamatanTanamSingkongPresenter(IFormPengamatanTanamSingkongView view) {
        this.view = view;
    ...
    void createPengamatan(TanamSingkongModel model) {
...
//                    .header("username", nik)
        ...
        restService.create(NetworkService.class).pengamatanTanamSingkong(model)
