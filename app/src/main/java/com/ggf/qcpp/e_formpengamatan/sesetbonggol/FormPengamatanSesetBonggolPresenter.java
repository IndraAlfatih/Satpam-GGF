...
public class FormPengamatanSesetBonggolPresenter {

    final IFormPengamatanSesetBonggolView view;
    private final Retrofit restService;
    private final String TAG = "Auth Presenter";

    FormPengamatanSesetBonggolPresenter(IFormPengamatanSesetBonggolView view) {
        this.view = view;
    ...
    void createPengamatan(SesetBonggolModel model) {
...
//                    .header("username", nik)
        ...
        restService.create(NetworkService.class).pengamatanSesetBonggol(model)
                .enqueue(new Callback<CommonResponse>() {
                    @Override
                    public void onResponse(Call<CommonResponse> call, Response<CommonResponse> CommonRespon) {
                        view.hideLoadingIndicator();

//                        if (CommonRespon.body().getSuccess())
                            view.onCreateSuccess(CommonRespon.body() != null ? CommonRespon.body().getRm() : null);
//                        else
