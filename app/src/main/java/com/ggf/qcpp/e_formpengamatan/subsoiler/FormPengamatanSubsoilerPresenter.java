...
public class FormPengamatanSubsoilerPresenter {

    final IFormPengamatanSubsoilerView view;
    private final Retrofit restService;
    private final String TAG = "Auth Presenter";

    FormPengamatanSubsoilerPresenter(IFormPengamatanSubsoilerView view) {
        this.view = view;
    ...
    void createPengamatan(SubsoilerModel model) {
