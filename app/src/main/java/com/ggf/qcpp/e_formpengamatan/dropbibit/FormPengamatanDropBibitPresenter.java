...
public class FormPengamatanDropBibitPresenter {

    final IFormPengamatanDropBibitView view;
    private final Retrofit restService;
    private final String TAG = "Auth Presenter";

    FormPengamatanDropBibitPresenter(IFormPengamatanDropBibitView view) {
        this.view = view;
    ...
    void createPengamatan(DropBibitModel model) {
