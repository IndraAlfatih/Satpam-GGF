...
public class FormPengamatanPetikBibitPresenter {

    final IFormPengamatanPetikBibitView view;
    private final Retrofit restService;
    private final String TAG = "Auth Presenter";

    FormPengamatanPetikBibitPresenter(IFormPengamatanPetikBibitView view) {
        this.view = view;
    ...
    void createPengamatan(PetikBibitModel model) {
