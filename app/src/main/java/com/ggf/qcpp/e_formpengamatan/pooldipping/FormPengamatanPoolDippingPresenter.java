...
public class FormPengamatanPoolDippingPresenter {

    final IFormPengamatanFinishingView view;
    private final Retrofit restService;
    private final String TAG = "Auth Presenter";

    FormPengamatanPoolDippingPresenter(IFormPengamatanFinishingView view) {
        this.view = view;
    ...
    void createPengamatan(PoolDippingModel model) {
