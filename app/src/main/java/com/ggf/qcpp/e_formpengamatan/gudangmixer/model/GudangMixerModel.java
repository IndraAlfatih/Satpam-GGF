package com.ggf.qcpp.e_formpengamatan.gudangmixer.model;
...
public class GudangMixerModel implements Serializable {
    ...
    public String getRencanaVolumeAir() {
        return rencanaVolumeAir;
    }

    public void setRencanaVolumeAir(String rencanaVolumeAir) {
        this.rencanaVolumeAir = rencanaVolumeAir;
    }

    public String getRealVolumeAir() {
        return realVolumeAir;
    }

    public void setRealVolumeAir(String realVolumeAir) {
