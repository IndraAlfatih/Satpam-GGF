...
public class FormPengamatanJumlahBarisPresenter {

    final IFormPengamatanJumlahBarisView view;
    private final Retrofit restService;
    private final String TAG = "Auth Presenter";

    FormPengamatanJumlahBarisPresenter(IFormPengamatanJumlahBarisView view) {
        this.view = view;
    ...
    void createPengamatan(JumlahBarisModel model) {
