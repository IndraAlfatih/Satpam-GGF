...
public class FormPengamatanPhTanahPresenter {

    final IFormPengamatanPhTanahView view;
    private final Retrofit restService;
    private final String TAG = "Auth Presenter";

    FormPengamatanPhTanahPresenter(IFormPengamatanPhTanahView view) {
        this.view = view;
    ...
    void createPengamatan(PhtanahModel model) {
