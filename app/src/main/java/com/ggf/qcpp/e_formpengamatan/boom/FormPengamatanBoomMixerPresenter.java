...
public class FormPengamatanBoomMixerPresenter {

    final IFormPengamatanBoomMixerView view;
    private final Retrofit restService;
    private final String TAG = "Auth Presenter";

    FormPengamatanBoomMixerPresenter(IFormPengamatanBoomMixerView view) {
        this.view = view;
    ...
    void createPengamatan(BoomMixerModel model) {
...
//                    .header("username", nik)
        ...
        restService.create(NetworkService.class).pengamatanBoomMixer(model)
